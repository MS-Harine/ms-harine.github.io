      ...
      var t = F(7320),
          ...
          return (0, t.BX)(e.default, {
            children: [
              ...
              Array.isArray(n)
                ...
                : (0, t.tZ)('meta', { property: 'og:image', content: n }, n),
              ...
              (0, t.tZ)('link', {
                rel: 'canonical',
                href: r || ''.concat(A().siteUrl).concat(a.asPath),
              }),
            ],
          })
        },
        ...
        r = function (u) {
          var D = u.title,
            F = u.description,
            E = A().siteUrl + A().socialBanner,
            B = A().siteUrl + A().socialBanner,
            r = (0, C.useRouter)()
          return (0, t.BX)(t.HY, {
            children: [
              (0, t.tZ)(n, { title: D, description: F, ogType: 'website', ogImage: E, twImage: B }),
              (0, t.tZ)(e.default, {
                children: (0, t.tZ)('link', {
                  rel: 'alternate',
                  type: 'application/rss+xml',
                  title: ''.concat(F, ' - RSS feed'),
                  href: ''.concat(A().siteUrl).concat(r.asPath, '/feed.xml'),
                }),
              }),
            ],
          })
        ...
        a = function (u) {
          var D = u.authorDetails,
            ...
            s = new Date(B || E).toISOString(),
            l = (0 === i.length ? [A().socialBanner] : 'string' === typeof i ? [i] : i).map(
              function (u) {
            ...
            children: [
              ...
              (0, t.BX)(e.default, {
                children: [
                  ...
                  B && (0, t.tZ)('meta', { property: 'article:modified_time', content: s }),
                  (0, t.tZ)('script', {
